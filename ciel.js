...
(function(){
  ...
  var th=lang==='th';
  var L=th?{wic:'รู้จัก Ciel',menu:'เมนู',hs:'เฮดสปา',bp:'นโยบายการจอง',story:'เรื่องราว',media:'สื่อ',ig:'Instagram',contact:'ติดต่อ',resv:'จองคิว',sig:'Signature'}
          :{wic:'What is Ciel',menu:'Menu',hs:'Head Spa',bp:'Booking Policy',story:'Story',media:'Media',ig:'Instagram',contact:'Contact',resv:'Reservation',sig:'Signature'};
  ...
  var items=[[L.story,u('index','#story')],[L.wic,u('what-is-ciel')],[L.menu,u('menu')],[L.hs,u('headspa')],[L.sig,'/signature.html'],[L.bp,u('booking-policy')],[L.media,u('press')],[L.ig,u('index','#instagram')],[L.contact,u('contact')],[L.resv,u('booking')]];
